...
import {
  ...
  Paperclip, Upload, Link2, ExternalLink, Download, FileImage, FileVideo, File,
} from 'lucide-react';
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-5">
          ...
          <div>
            ...
            {/* Add Link form */}
            {showAddLink && (
              <div className="mb-3 p-3 bg-gray-50/50 dark:bg-slate-800/20 rounded-lg border border-gray-200 dark:border-slate-700/50">
            ...
            {links.length > 0 && (
              <div className="space-y-1.5 mb-3">
                {links.map((link) => (
                  <div
                    key={link.id}
                    className="flex items-center gap-2.5 px-3 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-slate-800/30 dark:hover:bg-slate-800/50 group transition-colors"
                  >
              ...
              <div className="space-y-2">
                ...
                {attachments
                  ...
                  .map((attachment) => (
                    <div
                      key={attachment.id}
                      className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-slate-800/30 dark:hover:bg-slate-800/50 group transition-colors"
                    >
            ...
            {attachments.length === 0 && links.length === 0 && !showAddLink && (
              ...
              >
                ...
                <p className="text-[10px] text-gray-300 dark:text-slate-600 mt-0.5">
                  Attach docs, images/screenshots, or links related to this task
                </p>
              </div>
            )}
          </div>
